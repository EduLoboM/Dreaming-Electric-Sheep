...
from dreaming_electric_sheep import Content, Request, Response, StreamedContent
...
class HTTP2Connection(HTTPConnection):
    ...
    def _convert_request_to_h2_headers(self, request: Request) -> list[tuple[str, str]]:
        """Convert a Dreaming Electric Sheep Request to HTTP/2 pseudo-headers and headers."""
    ...
    async def send(self, request: Request) -> Response:
        ...
        Args:
            request: The Dreaming Electric Sheep Request object to send
    ...
    async def _receive_response(
        ...
        Returns:
            Dreaming Electric Sheep Response object with streaming content
        """
        ...
        # Convert to Dreaming Electric Sheep Response
        response_headers = []
...
class HTTP11Connection(HTTPConnection):
    ...
    def _convert_request_to_h11(
        ...
        """Convert a Dreaming Electric Sheep Request to h11 request."""
