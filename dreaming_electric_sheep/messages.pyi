...
class Message:
    ...
    async def json(self, loads: Callable[[str], Any] | None = None) -> Any: ...
...
def acquire_request(method: str, path: bytes, raw_query: bytes, headers: list[HeaderType], scope: Any) -> Request: ...
def release_request(request: Request) -> None: ...
def acquire_response(status: int = 200, headers: list[HeaderType] | None = None, content: Content | None = None) -> Response: ...
