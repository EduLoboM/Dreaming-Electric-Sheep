...
from dreaming_electric_sheep.messages import Request, Response, get_absolute_url_to_path
from dreaming_electric_sheep.middlewares import MiddlewareCategory
from dreaming_electric_sheep.server.application import Application, ApplicationEvent
...
from dreaming_electric_sheep.server.authorization import allow_anonymous
...
def get_logger() -> logging.Logger:
    logger = logging.getLogger("dreaming_electric_sheep.oidc")
...
def use_openid_connect(
    ...
    auth_handler : OpenIDTokensHandler | None
        ...
        Dreaming Electric Sheep offers two kinds of this class out of the box: one that uses cookies
