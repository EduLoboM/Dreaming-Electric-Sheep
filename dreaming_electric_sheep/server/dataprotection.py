...
from dreaming_electric_sheep.baseapp import get_logger
...
def get_keys() -> list[str]:
    ...
    APP_SECRET_2). The prefix can be customized using the DREAMING_ELECTRIC_SHEEP_SECRET_PREFIX
    ...
    Example:
        ...
        export DREAMING_ELECTRIC_SHEEP_SECRET_PREFIX="MY_SECRET"
