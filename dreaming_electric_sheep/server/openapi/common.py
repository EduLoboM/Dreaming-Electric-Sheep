...
from dreaming_electric_sheep.server.routing import Route, Router
from dreaming_electric_sheep.url import join_prefix
...
class DefaultSerializer(Serializer):
    """
    Default OAD serializer used by Dreaming Electric Sheep.
    Dreaming Electric Sheep generates OpenAPI Specification files containing
    ...
    def save_spec(self, destination: str) -> None:
        ...
        **Typical workflow**
        ...
        3. At runtime (TEST / PROD) set the environment variable so that
           Dreaming Electric Sheep loads the baked spec instead of regenerating it::
