...
Usage:
    from dreaming_electric_sheep.server.otel import use_open_telemetry
...
from dreaming_electric_sheep.server.env import get_env
...
def use_open_telemetry(
    ...
    """
    Configures OpenTelemetry tracing and logging for a Dreaming Electric Sheep application.
    ...
    Args:
        app (Application): The Dreaming Electric Sheep application instance.
    ...
    if os.getenv("OTEL_RESOURCE_ATTRIBUTES") is None:
        # set a default value
        set_attributes("dreaming-electric-sheep-app")
