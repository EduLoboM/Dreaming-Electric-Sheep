...
exporters for logging and tracing in Dreaming Electric Sheep applications. This code is vendor
...
Usage:
    from dreaming_electric_sheep.server.otel.otlp import use_open_telemetry_otlp
...
def use_open_telemetry_otlp(app: Application, middleware: OTELMiddleware | None = None):
    """
    Configures OpenTelemetry for a Dreaming Electric Sheep application using OTLP exporters.
    ...
    Args:
        app: The Dreaming Electric Sheep Application instance.
