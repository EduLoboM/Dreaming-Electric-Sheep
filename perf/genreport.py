...
def load_results(
    ...
    results = []
    for filename in glob.glob(f"{results_dir}/dreaming_electric_sheep_perf_*.json"):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Compare Dreaming Electric Sheep benchmark results")
    parser.add_argument(
        "--results-dir",
        type=str,
